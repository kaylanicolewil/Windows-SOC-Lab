...
4) Created a Log Repository in Log Analytics Workspace then connected it to my VM so the logs would be forwarded to the repository. A data collection rule was created to allow me to access the VM logs inside of the SIEM.
